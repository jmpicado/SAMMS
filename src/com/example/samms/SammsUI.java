...
import com.example.samms.windows.accordions.SAMMSMercadosAccordion;
...
public class SammsUI extends UI {
	...
	protected void init(VaadinRequest request) {
		...
		SAMMSTabInstruments tab5 = new SAMMSTabInstruments(this);
		tabsheet2.addTab(tab5, "Instrumentos");
		SAMMSTabTradables tab6 = new SAMMSTabTradables(this);
		tabsheet2.addTab(tab6, "Tradables");
		
		TabSheet tabsheet3 = new TabSheet();
		tabsheet3.setHeight("700.0px");tabsheet3.setWidth("1000.0px");
		SAMMSTabBookOrder tab7 = new SAMMSTabBookOrder(this);
		tabsheet3.addTab(tab7, "Orders 	Book");
        ...
        menu.createTreeContent(barmenu, tabsheet1,tabsheet2,tabsheet3,_mainLayout);
		...
		accordion.addTab(new SAMMSMercadosAccordion(), "Mercados", null);
