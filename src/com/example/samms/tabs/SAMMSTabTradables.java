...
public class SAMMSTabTradables extends SAMMSTab {
	...
	public SAMMSTabTradables(SammsUI sammsUI) {
		super(sammsUI);
...
//		this.setCaption("Clock");
	...
	private void fillingTable() throws Exception {
		URL val = this.getClass().getResource("./data/tradables.json");
	    ...
	    JSONArray nodeArray = nodeRoot.getJSONArray("tradables");
...
//	    String sSDR = nodeStats.getString("sdr");
		...
		for (int i = 0; i< nodeArray.length(); i++){
			...
			table_Relaciones.addItem(new Object[]{obj.get("INSTRUMENTID"),obj.get("MARKETID"), symbol}, i+1);
		}		
	...
	private void buildMainLayout() throws Exception {
		// table_Relaciones
		table_Relaciones = new Table("Instrument Table");
		...
		table_Relaciones.addContainerProperty("INSTRUMENTID", String.class, null);
		table_Relaciones.addContainerProperty("MARKETID", String.class, null);
		table_Relaciones.addContainerProperty("SYMBOL", String.class, null);
		...
		filter_2.setCaption("Filter(MARKETID)");filter_2.setImmediate(false);filter_2.setNullSettingAllowed(true);
		filter_2.setWidth("250px");		filter_2.setHeight("-1px");
		filter_3 = new TextField();
		filter_3.setCaption("Filter(SYMBOL)");filter_3.setImmediate(false);filter_3.setNullSettingAllowed(true);
		...
		button_1.addClickListener(new Button.ClickListener() {
			public void buttonClick(ClickEvent event) {
				...
				Filter filter1 = new SimpleStringFilter("INSTRUMENTID",filterS1, true, false);Filter filter2 = new SimpleStringFilter("MARKETID",filterS2, true, false);
				Filter filter3 = new SimpleStringFilter("SYMBOL",filterS3, true, false);
				if ( !filterS1.isEmpty() )
		...
		horLayout.addComponent(filter_1);horLayout.addComponent(filter_2);horLayout.addComponent(filter_3);
