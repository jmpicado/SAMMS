...
public class SAMMSTabIntermediarios extends SAMMSTab {
	...
	public SAMMSTabIntermediarios(SammsUI sammsUI) {
		super(sammsUI);
...
//		this.setCaption("Clock");
	...
	private void fillingTable() throws Exception {
		URL val = this.getClass().getResource("./data/intermediarios.json");
	    ...
	    JSONArray nodeArray = nodeRoot.getJSONArray("intermediarios");
...
//	    String sSDR = nodeStats.getString("sdr");
		...
		for (int i = 0; i< nodeArray.length(); i++){
			...
			table_Relaciones.addItem(new Object[]{obj.get("RECID"),obj.get("INTERMEDIARYID"), obj.get("NINTYPE"),
							obj.get("PERSONNAME")}, i+1);
		}		
	...
	private void buildMainLayout() throws Exception {
		// table_Relaciones
		table_Relaciones = new Table("Intermediary Table");
		...
		table_Relaciones.addContainerProperty("NYNTYPE", String.class, null);
		table_Relaciones.addContainerProperty("PERSONNAME", String.class, null);
		...
		filter_2.setCaption("Filter(INTERMEDIARYID)");filter_2.setImmediate(false);filter_2.setNullSettingAllowed(true);
		filter_2.setWidth("250px");		filter_2.setHeight("-1px");
		filter_3 = new TextField();
		filter_3.setCaption("Filter(NYNTYPE)");filter_3.setImmediate(false);filter_3.setNullSettingAllowed(true);
		filter_3.setWidth("180px");		filter_3.setHeight("-1px");
		filter_4 = new TextField();
		filter_4.setCaption("Filter(PERSONNAME)");filter_4.setImmediate(false);filter_4.setNullSettingAllowed(true);
		...
		button_1.addClickListener(new Button.ClickListener() {
			public void buttonClick(ClickEvent event) {
				...
				String filterS4 = (String) filter_4.getValue();
				Filter filter1 = new SimpleStringFilter("RECID",filterS1, true, false);Filter filter2 = new SimpleStringFilter("INTERMEDIARYID",filterS2, true, false);
				Filter filter3 = new SimpleStringFilter("NYNTYPE",filterS3, true, false);Filter filter4 = new SimpleStringFilter("PERSONNAME",filterS4, true, false);
				if ( !filterS1.isEmpty() )
		...
		horLayout.addComponent(filter_1);horLayout.addComponent(filter_2);horLayout.addComponent(filter_3);horLayout.addComponent(filter_4);
