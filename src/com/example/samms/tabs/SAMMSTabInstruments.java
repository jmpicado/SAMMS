...
public class SAMMSTabInstruments extends SAMMSTab {
	...
	public SAMMSTabInstruments(SammsUI sammsUI) {
		super(sammsUI);
...
//		this.setCaption("Clock");
	...
	private void fillingTable() throws Exception {
		URL val = this.getClass().getResource("./data/instrumentos.json");
	    ...
	    JSONArray nodeArray = nodeRoot.getJSONArray("instrumentos");
...
//	    String sSDR = nodeStats.getString("sdr");
		...
		for (int i = 0; i< nodeArray.length(); i++){
			...
			table_Relaciones.addItem(new Object[]{obj.get("INSTRUMENTID"),obj.get("INSTRUMENTCLASSID"), obj.get("STOCKOWNERRIGHTS"),
							obj.get("SHORTDESCRIPTION"),obj.get("INSTRUMENTNOTES"),obj.get("ISSUERID")}, i+1);
		}		
	...
	private void buildMainLayout() throws Exception {
		...
		table_Relaciones.addContainerProperty("INSTRUMENTCLASSID", String.class, null);
		table_Relaciones.addContainerProperty("STOCKOWNERRIGHTS", String.class, null);
		table_Relaciones.addContainerProperty("SHORTDESCRIPTION", String.class, null);
		table_Relaciones.addContainerProperty("INSTRUMENTNOTES", String.class, null);
		table_Relaciones.addContainerProperty("ISSUERID", String.class, null);
