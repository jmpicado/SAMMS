...
public class SAMMSTabIssuers extends SAMMSTab {
	...
	public SAMMSTabIssuers(SammsUI sammsUI) {
		super(sammsUI);
...
//		this.setCaption("Clock");
	...
	private void fillingTable() throws Exception {
		URL val = this.getClass().getResource("./data/issuers.json");
	    ...
	    JSONArray nodeArray = nodeRoot.getJSONArray("issuers");
...
//	    String sSDR = nodeStats.getString("sdr");
		...
		for (int i = 0; i< nodeArray.length(); i++){
			...
			table_Relaciones.addItem(new Object[]{obj.get("RECID"),obj.get("ISSUERID"), obj.get("ISSUERCLASSID"),
							obj.get("PERSONNAME"),obj.get("TAXCODE")}, i+1);
		}		
	...
	private void buildMainLayout() throws Exception {
		// table_Relaciones
		table_Relaciones = new Table("Issuer Table");
		...
		table_Relaciones.addContainerProperty("TAXCODE", String.class, null);
		...
		filter_2.setCaption("Filter(ISSUERID)");filter_2.setImmediate(false);filter_2.setNullSettingAllowed(true);
		...
		filter_5.setCaption("Filter(TAXCODE)");filter_5.setImmediate(false);filter_5.setNullSettingAllowed(true);
