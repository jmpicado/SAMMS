 ...
 *
 */
public class SAMMSTab5 extends SAMMSTab {
	...
	public SAMMSTab5(SammsUI sammsUI) {
		super(sammsUI);
...
//		this.setCaption("Clock");
	...
	private void fillingTable() throws Exception {
		URL val = this.getClass().getResource("./data/index.json");
	    ...
	    JSONArray nodeArray = nodeRoot.getJSONArray("indices");
...
//	    String sSDR = nodeStats.getString("sdr");
		...
		for (int i = 0; i< nodeArray.length(); i++){
			...
			table_Relaciones.addItem(new Object[]{obj.get("RECID"),obj.get("INDEXID"), obj.get("DESCRIPTION"),
							obj.get("VALOR")}, i+1);
		}		
	...
	private void buildMainLayout() throws Exception {
		...
		table_Relaciones.addContainerProperty("INDEXID", String.class, null);
		table_Relaciones.addContainerProperty("DESCRIPTION", String.class, null);
		table_Relaciones.addContainerProperty("VALOR", String.class, null);
